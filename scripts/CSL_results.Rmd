...
ggplot(phi.vals %>% filter(rate == 'Detection' & exclude_det != 'Y' & year != 20),
  ...
  scale_x_continuous(breaks = c(seq(1, 25, by = 5)), labels = c(seq(2001, (2001+n_occasions-1), by = 5)))
